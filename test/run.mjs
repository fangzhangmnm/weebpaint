...
import "./shape-brush.test.mjs";      // 形状笔引擎（ADR-0005；2026-09-18 回滚复活）：恒压 / taper 覆写 / 三子工具几何 / 约束 / cancel / pixelMode
...
import "./pressure-curve.test.mjs"; // 2026-09-05 压感曲线：LUT 恒等/gamma 回落/常数=无压感/笔刷 JSON 可选键透传（resolveBrush·smudge）
...
import "./context-toolbar.test.mjs";   // 2026-09-02 C4 顶栏条登记表守卫（跑在 app-boot 之后：各 owner init 已登记）
...
import "./color-mix-lut.test.mjs";          // 2026-09-06 sRGB 传递函数 LUT 层 1：fast 版误差 < 1/255（议程 §H）
