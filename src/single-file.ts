// single-file.ts —— 单文件 html 交付物的运行时接缝（P6；约束调研 = 0825 survey §5，拍板 = verdicts §2.9）。
// created 2026-08-27 by Claude Fable 5.
//
// 打包器（scripts/pack-single.mjs）把外部资产灌进 `window.__WEEBPAINT_EMBED__`（文本原文 / 二进制 base64），
...
export const isSingleFile = (): boolean => _embed() != null;
